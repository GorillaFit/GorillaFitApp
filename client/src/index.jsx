...
//calories
      ...
      // <SearchExercise className = 'right' addExercise={this.addExercise.bind(this)}/>
       // <Exercises className = 'right' exercises={this.state.exercises}/>
       // <CalorieOutput className = 'right' calorieOutput={this.state.calorieOutput}/>
